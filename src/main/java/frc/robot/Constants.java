...
public final class Constants {
  ...
  public static class ChassisConstants {
    ...
    public static class SwerveModuleConstants {
      public static final double MOVE_KP = 0.0015; //0.000002;
      public static final double MOVE_KI = 0;//0.000035; //0.00007;
      public static final double MOVE_KD = 0;//0.07; //0.008;
      ...
      public static final double MOVE_KS = 0.035; //0.05; // 0.15851/12; //0.0362;
      public static final double MOVE_KV = 0.215; // 0.263; //0.012314/12; //0.0862;
